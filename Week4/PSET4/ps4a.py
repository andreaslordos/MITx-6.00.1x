...
def updateHand(hand, word):
    ...
    for g in range(len(word)):
        ...
        hand[letter]-=1
    return(hand)
    #for some reason this mutates the hand?
...
def calculateHandlen(hand):
    ...
    for letter in range(len(alphabet)):
        total=total+int(hand.get(alphabet[letter],0))
    return(total)
    ...
    while calculateHandlen(hand)>0:
        ...
        if userinput==".":
            ...
            if isValidWord(userinput,hand,wordList):
                ...
                totalscore+=score
                print('"'+userinput+'"'+' earned '+str(score)+' points. Total: '+str(totalscore)+' points.')
                print()
...
def playGame(wordList):
    ...
    while True:
        ...
        elif userinput[0]=="R" or userinput[0]=="r" and userinput!="":
            if oldhand=="":
                print("You have not played a hand yet. Please play a new hand first!")
            else:
                hand=oldhand
                playHand(hand, wordList, n)
        elif userinput[0]=="e" or userinput[0]=="E" and userinput!="":
                break
        else:
            print("Invalid command.")
